...
- 상태관리 라이브러리.
- 컴포넌트들의 상태관리를 위하여 사용.
- 리덕스에서는 한 애플리케이션 당 하나의 스토어를 만들 수 있다.

Action : 상태 변화가 필요할때, 발생시키는 거!
Resucer : 실제 상태 변화를 일으키는 함수!

npm i --save redux react-redux

react 에서 redux를 사용하기 위해 진행해야 하는일.

1. 액션 정의 및 액션 생성함수 정의
2. 상태와 리듀서 정의
3. combineReducers  -> 리듀서 합치기
4. 스토어 정의 및 스토어 연동
5. 컴포넌트에 스토어 연동
